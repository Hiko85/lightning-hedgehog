...
def bar_murder():
    ...
    if choice == "1":
        ...
        print("Jelenlegi pontszámod:", get_score())
        return questioning_examining()
    elif choice == "2":
        update_score(10)
        print("\nAz orvos egyszerűen közli, hogy méreg végzett az áldozattal. Ráadásul a bort az áldozat feleségének kérésére hozták, ám a pincér szerint egy férfi hang"
              " adta le korábban a rendelést. Eközben Milo felhívja Ront, akitől megtudjátok, hogy a gyilkosságot az követte el, aki után Ron is nyomoz, vagyis "
...
def falling_body():
    ...
    if choice == "1":
        ...
        print("Jelenlegi pontszámod:", get_score())
        return investigating_informator()
    elif choice == "2":
        update_score(0)
...
def catch_culprit():
    ...
    if choice == "1":
        update_score(0)
        print("A végső pontszámod:", get_score())
        return
    elif choice == "2":
        update_score(0)
        print("A végső pontszámod:", get_score())
...
def killer_story():
    ...
    if choice == "1":
        ...
        print("Jelenlegi pontszámod:", get_score())
        return first_meeting_talk()
    else:
        print("Érvénytelen választás. Kérlek, próbáld újra.")
        killer_story(choice)


def retry_or_exit_killer():
...
def first_meeting():
    ...
    if choice == "1":
        ...
        print("Jelenlegi pontszámod:", get_score())
        return follow_the_couple()
    else:
        print("Érvénytelen választás. Kérlek, próbáld újra.")
        killer_story(choice)

def first_meeting_talk():
    choice = input("Választásod: ").strip()
    ...
    if choice == "1":
        ...
        print("Az elért pontszámod:", get_score())
        return retry_or_exit_killer()
    else:
        print("Érvénytelen választás. Kérlek, próbáld újra.")
        killer_story(choice)

def follow_the_couple():
    choice = input("Választásod: ").strip()
